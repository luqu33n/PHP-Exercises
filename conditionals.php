...
echo $redLight = true ? "<p>Stop the car!</p>" : "<p>Carry on!</p>";
...
elseif (!$redLight && !$yellowLight && !$greenLight === true) {
    echo "Power outage!";    
}
elseif ($redLight && $yellowLight === false && $greenLight === true) {
    echo "Keep moving!";    
}
elseif ($redLight xor $yellowLight === true && $greenLight === true) {
...
switch (true) {
    ...
    case (!$redLight && !$yellowLight && $greenLight):
        echo "Stop the car!";
        break;
    case (!$redLight xor !$yellowLight && $greenLight):
        echo "Stop the car!";
        break;
    default: 
        echo "Use the common sense and stay safe!";
